...
{ 
    ...
    template<typename T>
    inline VkPushConstantRange vkPushConstantRange(uint32_t offset,VkShaderStageFlagBits flag)
    {
    ...
    struct VulkanGraphicsPipelineFactoryMultiViewport
    {
        std::vector<VkPipelineShaderStageCreateInfo> shaderStages;
        VulkanVertexInputDescription vertexInputDescription;
        VkPipelineVertexInputStateCreateInfo vertexInputInfo;
    ...
    public:
        ...
        VulkanFrameBufferFactory& addArrayAttachment(VulkanImageArray* img,uint32_t index)
        {
        ...
        VkFramebuffer create(VkDevice dev,bool bClearAfterCreate = true)
        {
            ...
            m_frameBufferCreateInfo.attachmentCount = (uint32_t)m_attachments.size();
    ...
    public:
        ...
        VulkanSubmitInfo& setWaitSemaphore(VkSemaphore* wait,int32_t count)
        {
        ...
        VulkanSubmitInfo& setSignalSemaphore(VkSemaphore* signal,int32_t count)
        {
        ...
        VulkanSubmitInfo& setCommandBuffer(VkCommandBuffer* cb,int32_t count)
        {
        ...
        VulkanSubmitInfo& setCommandBuffer(VulkanCommandBuffer* cb,int32_t count)
        {
            submitInfo.commandBufferCount = count;
