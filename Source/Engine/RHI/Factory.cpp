...
namespace flower
{
    VkPipeline VulkanGraphicsPipelineFactory::buildMeshDrawPipeline(VkDevice device, VkRenderPass pass)
    {
    ...
    VkPipeline VulkanGraphicsPipelineFactory::buildMeshDrawPipeline(
        VkDevice device,
        VkRenderPass pass,
    ...
    VkPipeline VulkanGraphicsPipelineFactoryMultiViewport::buildMeshDrawPipeline(VkDevice device, VkRenderPass pass)
    {
        vertexInputInfo = vkVertexInputStateCreateInfo();
        ...
        viewportState.viewportCount = (uint32_t)viewport.size();
        viewportState.pViewports = viewport.data();
        viewportState.scissorCount = (uint32_t)scissor.size();
