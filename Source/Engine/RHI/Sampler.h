...
namespace flower
{
    ...
    public:
        ...
        void buildPointClampBorderSampler(VkBorderColor borderColor);
        void buildPointClampEdgeSampler();
        void buildPointRepeatSampler();
        void buildLinearClampSampler();
        void buildLinearClampNoMipSampler();
        void buildLinearRepeatSampler();

        void buildShadowFilterSampler();
    };
    ...
    private:
        ...
        // store sampler and it's bindless set index.
        typedef std::unordered_map<SamplerCreateInfo,std::pair<uint32_t,VkSampler>,SamplerCreateInfoHash> SamplerCache;
        SamplerCache m_samplerCache;

        std::unique_ptr<BindlessSampler> m_bindlessSamplerSet;
    ...
    public:
        ...
        BindlessSampler* getBindless(){ return m_bindlessSamplerSet.get(); }
    };
}